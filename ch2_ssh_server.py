...
server_port = 7777#int(sys.argv[2])
server_username = "RIMI"#sys.argv[3]
server_password = "rimi"#sys.argv[4]
server_host_key = paramiko.RSAKey(filename="ch2_ssh_server.key.py")
